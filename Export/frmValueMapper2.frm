VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmValueMapper2 
   Caption         =   "Map Value Columns"
   ClientHeight    =   6525
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   7350
   OleObjectBlob   =   "frmValueMapper2.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmValueMapper2"
...
Private WithEvents Model As clsValueMapperViewModel
...
Private Function TryReselectListItem(ByRef lv As ListView, ByVal key As String) As Boolean
    Dim i As Long
